...
//  WeatherApp
//
//  Created by Konstantin Pimbursky on 08.08.2021.
//
...
class SunAndMoonView: UIView {
    ...
    private func setupSubviews() {
        self.addSubviews(titleLabel, moonPhaseImageView, moonPhaseLabel, sunIcon, moonIcon,
                         sunDurationLabel, moonDurationLabel, sunriseTitleLabel, sunsetTitleLabel,
                         sunriseLabel, sunsetLabel, moonriseTitleLabel, moonsetTitleLabel,
                         moonriseLabel, moonsetLabel, verticalLine)
